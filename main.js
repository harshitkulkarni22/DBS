...
document.addEventListener('DOMContentLoaded', () => {
     ...
     ScheduleDB.onupgradeneeded = function(e) {
          ...
          objectStore.createIndex('WealthManagerName', 'WealthManagerName', { unique: false } );
     ...
     function showConsultations() {
                 ...
                 consultations.appendChild(ConsultationHTML);
                    ...
                    if(!consultations.firstChild) {
                      ...
                      consultations.appendChild(noSchedule);
                        ...
                        services.textContent = 'Cancel Your Meet with HNI '
                    }
               }
          }
     }
          ...
          transaction.oncomplete = () => {
               ...
               if(!consultations.firstChild) {
                    ...
                    services.textContent = 'Change your meet hours';
                   ...
                   services.textContent = 'Cancel your meet with HNIs'
               }
          }
     }
